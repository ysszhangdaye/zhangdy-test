package com.zhangdy.test.chat.client.handler;
...
public class ChatClientHandler extends SimpleChannelInboundHandler<IMMessage> {
                ...
                do{
                    if(scanner.hasNext()){
                        ...
                        if("exit".equals(input)){
                            message = new IMMessage(IMP.LOGOUT.getCommand(),"Console",System.currentTimeMillis(),nickName);
                        }else{
                            message = new IMMessage(IMP.CHAT.getCommand(),System.currentTimeMillis(),nickName,input);
                        }
                    }
                }
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        this.ctx = ctx;
        IMMessage message = new IMMessage(IMP.LOGIN.getCommand(),"Console",System.currentTimeMillis(),this.nickName);
    ...
    @Override
    protected void channelRead0(ChannelHandlerContext channelHandlerContext, IMMessage m) throws Exception {
